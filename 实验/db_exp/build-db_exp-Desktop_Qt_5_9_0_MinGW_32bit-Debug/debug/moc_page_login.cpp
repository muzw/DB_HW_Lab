...
QT_MOC_LITERAL(3, 29, 12), // "QSqlDatabase"
QT_MOC_LITERAL(4, 42, 2), // "db"
QT_MOC_LITERAL(5, 45, 20), // "on_SignInBtn_clicked"
QT_MOC_LITERAL(6, 66, 21) // "on_pushButton_clicked"

    },
    "Page_login\0sendLoginSuccess\0\0QSqlDatabase\0"
    "db\0on_SignInBtn_clicked\0on_pushButton_clicked"
};
...
void Page_login::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendLoginSuccess((*reinterpret_cast< QSqlDatabase(*)>(_a[1]))); break;
        ...
        {
            typedef void (Page_login::*_t)(QSqlDatabase );
...
const QMetaObject Page_login::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Page_login.data,
      qt_meta_data_Page_login,  qt_static_metacall, nullptr, nullptr}
};
...
void *Page_login::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Page_login.stringdata0))
        return static_cast<void*>(const_cast< Page_login*>(this));
...
// SIGNAL 0
void Page_login::sendLoginSuccess(QSqlDatabase _t1)
{
